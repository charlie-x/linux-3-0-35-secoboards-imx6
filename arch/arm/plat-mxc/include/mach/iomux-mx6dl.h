...
#define MX6DL_GPIO_4_PAD_CTRL (PAD_CTL_PUE |  \
                PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_MED |       \
                PAD_CTL_DSE_40ohm | PAD_CTL_SRE_FAST)

#define MX6DL_GPIO_9_PWM_CTRL (PAD_CTL_PUE |  \
                PAD_CTL_PUS_22K_UP | PAD_CTL_SPEED_HIGH |       \
                PAD_CTL_DSE_240ohm | PAD_CTL_SRE_FAST)


#define MX6DL_PAD_USBOTG_ID_UP_CTRL (PAD_CTL_PKE | PAD_CTL_PUE |            \
                PAD_CTL_DSE_40ohm | PAD_CTL_PUS_100K_UP |             \
                PAD_CTL_HYS | PAD_CTL_SPEED_MED)

#define MX6DL_PAD_USBOTG_ID_DOWN_CTRL (PAD_CTL_PKE | PAD_CTL_PUE |            \
                PAD_CTL_DSE_40ohm | PAD_CTL_PUS_100K_DOWN |             \
                PAD_CTL_HYS | PAD_CTL_SPEED_MED)

#define MX6DL_CCM_CLK2_PAD_CTRL (PAD_CTL_PKE | PAD_CTL_PUE |        \
...
#define MX6DL_PAD_GPIO_1__USBOTG_ID_UP                                    \
		IOMUX_PAD(0x05E0, 0x0210, 3, 0x0790, 1, MX6DL_PAD_USBOTG_ID_UP_CTRL)
#define MX6DL_PAD_GPIO_1__USBOTG_ID_DOWN                                    \
		IOMUX_PAD(0x05E0, 0x0210, 3, 0x0790, 1, MX6DL_PAD_USBOTG_ID_DOWN_CTRL)
...
#define MX6DL_PAD_GPIO_17__GPIO_7_12                                           \
		IOMUX_PAD(0x05E8, 0x0218, 5, 0x0000, 0, MX6DL_USDHC_PAD_CTRL)
...
#define MX6DL_PAD_GPIO_2__GPIO_1_2                                             \
		IOMUX_PAD(0x05F4, 0x0224, 5, 0x0000, 0, MX6DL_PAD_USBOTG_ID_UP_CTRL)
...
#define MX6DL_PAD_GPIO_3__CCM_CLKO2                                            \
		IOMUX_PAD(0x05F8, 0x0228, 4, 0x0000, 0, MX6DL_CCM_CLK2_PAD_CTRL)
...
#define MX6DL_PAD_GPIO_4__GPIO_1_4                                             \
		IOMUX_PAD(0x05FC, 0x022C, 5, 0x0000, 0, MX6DL_PAD_USBOTG_ID_UP_CTRL)
...
#define MX6DL_PAD_KEY_COL2__GPIO_4_10                                          \
		IOMUX_PAD(0x0634, 0x024C, 5, 0x0000, 0, MX6DL_ENET_PAD_CTRL)
...
#define MX6DL_PAD_SD2_DAT0__GPIO_1_15                                          \
		IOMUX_PAD(0x06E4, 0x02FC, 5, 0x0000, 0, MX6DL_PAD_USBOTG_ID_UP_CTRL)
...
#define MX6DL_PAD_SD2_DAT2__GPIO_1_13                                          \
		IOMUX_PAD(0x06EC, 0x0304, 5, 0x0000, 0, MX6DL_PAD_USBOTG_ID_UP_CTRL)

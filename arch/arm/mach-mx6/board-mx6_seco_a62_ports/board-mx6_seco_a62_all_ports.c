...
static void __init board_mx6_seco_a62_port_2_config(void)
{
        ...
        if (cpu_is_mx6q()){
		if(PCB_IS_REV_A)
                	mxc_iomux_v3_setup_multiple_pads(mx6qd_seco_a62_port_2_conf_1_pads_reva,
                        	ARRAY_SIZE(mx6qd_seco_a62_port_2_conf_1_pads_reva));
		if(PCB_IS_REV_B)
                        mxc_iomux_v3_setup_multiple_pads(mx6qd_seco_a62_port_2_conf_1_pads_revb,
                                ARRAY_SIZE(mx6qd_seco_a62_port_2_conf_1_pads_revb));
        }
        else if (cpu_is_mx6dl()) {
		if(PCB_IS_REV_A)
                	mxc_iomux_v3_setup_multiple_pads(mx6sdl_seco_a62_port_2_conf_1_pads_reva,
                        	ARRAY_SIZE(mx6sdl_seco_a62_port_2_conf_1_pads_reva));
		if(PCB_IS_REV_B)
			mxc_iomux_v3_setup_multiple_pads(mx6sdl_seco_a62_port_2_conf_1_pads_revb,
                                ARRAY_SIZE(mx6sdl_seco_a62_port_2_conf_1_pads_revb));
...
static void __init board_mx6_seco_a62_port_8_config(void)
{
        ...
        if (cpu_is_mx6q()){
                mxc_iomux_v3_setup_multiple_pads(mx6qd_seco_a62_port_8_conf_3_pads,
                        ARRAY_SIZE(mx6qd_seco_a62_port_8_conf_3_pads));
        }
        else if (cpu_is_mx6dl()) {
                mxc_iomux_v3_setup_multiple_pads(mx6sdl_seco_a62_port_8_conf_3_pads,
                        ARRAY_SIZE(mx6sdl_seco_a62_port_8_conf_3_pads));
...
// PORT 10
static void __init board_mx6_seco_a62_port_10_config(void)
{
	if(PCB_IS_REV_B) {
#ifdef CONFIG_A62_PORT_10_CONF_1
	        if (cpu_is_mx6q()){
	                mxc_iomux_v3_setup_multiple_pads(mx6qd_seco_a62_port_10_conf_1_pads,
	                        ARRAY_SIZE(mx6qd_seco_a62_port_10_conf_1_pads));
	        }
	        else if (cpu_is_mx6dl()) {
	                mxc_iomux_v3_setup_multiple_pads(mx6sdl_seco_a62_port_10_conf_1_pads,
	                        ARRAY_SIZE(mx6sdl_seco_a62_port_10_conf_1_pads));
	        ...
	        if (cpu_is_mx6q()){
	                mxc_iomux_v3_setup_multiple_pads(mx6qd_seco_a62_port_10_conf_2_pads,
	                        ARRAY_SIZE(mx6qd_seco_a62_port_10_conf_2_pads));
	        }
	        else if (cpu_is_mx6dl()) {
	                mxc_iomux_v3_setup_multiple_pads(mx6sdl_seco_a62_port_10_conf_2_pads,
	                        ARRAY_SIZE(mx6sdl_seco_a62_port_10_conf_2_pads));
	        ...
	        if (cpu_is_mx6q()){
	                mxc_iomux_v3_setup_multiple_pads(mx6qd_seco_a62_port_10_conf_3_pads,
	                        ARRAY_SIZE(mx6qd_seco_a62_port_10_conf_3_pads));
	        }
	        else if (cpu_is_mx6dl()) {
	                mxc_iomux_v3_setup_multiple_pads(mx6sdl_seco_a62_port_10_conf_3_pads,
	                        ARRAY_SIZE(mx6sdl_seco_a62_port_10_conf_3_pads));
...
void __init board_mx6_seco_a62_ports_config_init(void)
{
	...
	board_mx6_seco_a62_port_10_config(); //Port 10

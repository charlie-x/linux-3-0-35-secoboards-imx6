...
static iomux_v3_cfg_t mx6qd_seco_a62_pads[] = {

    	
        /* AUDMUX */
	MX6Q_PAD_EIM_EB3__GPIO_2_31,	     // for AUDIO RESET
	...
	/* USB HUB */
	MX6Q_PAD_NANDF_CS2__CCM_CLKO2,		/* 24 MHz USB clock */
	...
	MX6Q_PAD_SD3_DAT5__GPIO_7_0,           /*eMMC_DAT3*/
#endif
#if defined(CONFIG_A62_EMMC_INTERFACE)
        /* USDHC3 -> eMMC ONBOARD */
        MX6Q_PAD_SD4_CLK__USDHC4_CLK_50MHZ,                     /*eMMC_CMD*/
        MX6Q_PAD_SD4_CMD__USDHC4_CMD_50MHZ,                     /*eMMC_CLK*/
        MX6Q_PAD_SD4_DAT0__USDHC4_DAT0_50MHZ,           /*eMMC_DAT0*/
        MX6Q_PAD_SD4_DAT1__USDHC4_DAT1_50MHZ,           /*eMMC_DAT1*/
        MX6Q_PAD_SD4_DAT2__USDHC4_DAT2_50MHZ,           /*eMMC_DAT2*/
        MX6Q_PAD_SD4_DAT3__USDHC4_DAT3_50MHZ,           /*eMMC_DAT3*/
        MX6Q_PAD_SD4_DAT4__USDHC4_DAT4_50MHZ,           /*eMMC_DAT4*/
        MX6Q_PAD_SD4_DAT5__USDHC4_DAT5_50MHZ,           /*eMMC_DAT5*/
        MX6Q_PAD_SD4_DAT6__USDHC4_DAT6_50MHZ,           /*eMMC_DAT6*/ 
        MX6Q_PAD_SD4_DAT7__USDHC4_DAT7_50MHZ,           /*eMMC_DAT7*/
#endif
	...
	/* LVDS */
    	MX6Q_PAD_GPIO_2__GPIO_1_2,			// Panel ON 
	MX6Q_PAD_DISP0_DAT8__PWM1_PWMO,			// LVDS BLT Control
	MX6Q_PAD_GPIO_4__GPIO_1_4,			// BL ON  

	/* TSC2006 PEN IRQ */
	MX6Q_PAD_GPIO_3__GPIO_1_3,

	/* TOUCHSCREEN SITRONIX */
	MX6Q_PAD_SD2_DAT0__GPIO_1_15,			// touch reset
	MX6Q_PAD_SD2_DAT2__GPIO_1_13,			// touch interrupt
	...
	*/
	...
	MX6Q_PAD_KEY_COL2__GPIO_4_10,                   /* Ethernet Power on */        
	...
	/* USBOTG ID pin */
	MX6Q_PAD_GPIO_1__USBOTG_ID,		// USB OTG ID //  
	MX6Q_PAD_EIM_D22__GPIO_3_22,            // USB OTG ID Power Enable (unused, kept only for probing otg driver) //
...
//	MX6Q_PAD_EIM_D28__I2C1_SDA,		/*I2C1_SDA - SMB*/ //   - for I2C
	...
	/* I2C2 */
	MX6Q_PAD_KEY_COL3__I2C2_SCL,     	/*I2C2_SCL hdmi Cec */
	MX6Q_PAD_KEY_ROW3__I2C2_SDA,    	/*I2C2_SDA hdmi Cec */		
	
	/* CAMERA CSI0 */
	MX6Q_PAD_CSI0_DAT18__GPIO_6_4,         /* Camera Power Enable */
	MX6Q_PAD_CSI0_DAT19__GPIO_6_5,		/* Camera Reset */
	MX6Q_PAD_CSI0_MCLK__CCM_CLKO,		/* Master Clock - MCLK */
	MX6Q_PAD_GPIO_5__I2C3_SCL,              /* I2C3_SCL*/ //   - for I2C3
	MX6Q_PAD_GPIO_6__I2C3_SDA,             /* I2C3_SDA*/ //   - for I2C3

	MX6Q_PAD_GPIO_0__GPIO_1_0,		/* EXP_GPIO_27  */
        MX6Q_PAD_CSI0_DAT4__GPIO_5_22,		/* EXP_GPIO_28  */

	MX6Q_PAD_NANDF_D3__GPIO_2_3,		/* POWER ON */
	MX6Q_PAD_NANDF_D4__GPIO_2_4,		/* ON_OFF */

};

static iomux_v3_cfg_t mx6qd_seco_a62_pads_reva[] = {
	MX6Q_PAD_EIM_D19__GPIO_3_19,    /*SS1*/         //   - to SPI  CS1
};

static iomux_v3_cfg_t mx6qd_seco_a62_pads_revb[] = {
	MX6Q_PAD_EIM_EB2__GPIO_2_30,    /*SS1*/         //   - to SPI  CS1
};

static iomux_v3_cfg_t mx6qd_seco_a62_otg_id_up_pads = MX6Q_PAD_GPIO_1__USBOTG_ID_UP;

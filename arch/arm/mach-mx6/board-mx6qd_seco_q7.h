...
static iomux_v3_cfg_t mx6qd_seco_q7_pads[] = {

    /* SDIO INTERFACE */
		/* USDHC1 - SD on board */
	MX6Q_PAD_SD1_CMD__USDHC1_CMD,			//	SD1_CMD
	MX6Q_PAD_SD1_CLK__USDHC1_CLK,			//	SD1_CLK
	MX6Q_PAD_NANDF_CS2__GPIO_6_15,			//	SD1_CD
	MX6Q_PAD_CSI0_DATA_EN__GPIO_5_20, 		//	SD1_WP
	MX6Q_PAD_SD1_DAT0__USDHC1_DAT0,			//	SD1_DAT0
	MX6Q_PAD_SD1_DAT1__USDHC1_DAT1,			//	SD1_DAT1
	MX6Q_PAD_SD1_DAT2__USDHC1_DAT2,			//	SD1_DAT2
	MX6Q_PAD_SD1_DAT3__USDHC1_DAT3,			//	SD1_DAT3
#ifdef CONFIG_MMC_8BIT
	MX6Q_PAD_NANDF_D0__USDHC1_DAT4,			//	SD1_DAT4
	MX6Q_PAD_NANDF_D1__USDHC1_DAT5,			//	SD1_DAT5
	MX6Q_PAD_NANDF_D2__USDHC1_DAT6,			//	SD1_DAT6
	MX6Q_PAD_NANDF_D3__USDHC1_DAT7,			//	SD1_DAT7
#endif
		/* USDHC3 -> eMMC on board */
	MX6Q_PAD_SD3_CLK__USDHC3_CLK_50MHZ,		//	eMMC_CMD
	MX6Q_PAD_SD3_CMD__USDHC3_CMD_50MHZ,		//	eMMC_CLK
	MX6Q_PAD_SD3_RST__USDHC3_RST,			//	eMMC_RESET
	...
	MX6Q_PAD_NANDF_D7__GPIO_2_7,			//	uSD_WP
    ...
    /* UART */
	    /* UART2 for debug */
	MX6Q_PAD_EIM_D26__UART2_TXD,		/*UART_TXD*/ // for UART2
	MX6Q_PAD_EIM_D27__UART2_RXD,		/*UART_RXD*/ // for UART2
		/* UART4 */
    ...
    /* WEIM BUS */   
	MX6Q_PAD_EIM_CS0__WEIM_WEIM_CS_0,			//    - for CPLD logic
	MX6Q_PAD_EIM_CS1__WEIM_WEIM_CS_1,			//    - for CPLD logic

    MX6Q_PAD_EIM_EB0__WEIM_WEIM_EB_0,			//    - for CPLD logic
	MX6Q_PAD_EIM_EB1__WEIM_WEIM_EB_1,			//    - for CPLD logic
	MX6Q_PAD_EIM_EB3__WEIM_WEIM_EB_3,			//    - for CPLD logic
      
    MX6Q_PAD_EIM_RW__WEIM_WEIM_RW,				//    - for CPLD logic
	MX6Q_PAD_EIM_OE__WEIM_WEIM_OE,				//    - for CPLD logic
	MX6Q_PAD_EIM_LBA__WEIM_WEIM_LBA,			//    - for CPLD logic
       
    MX6Q_PAD_EIM_DA0__WEIM_WEIM_DA_A_0,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA1__WEIM_WEIM_DA_A_1,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA2__WEIM_WEIM_DA_A_2,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA3__WEIM_WEIM_DA_A_3,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA4__WEIM_WEIM_DA_A_4,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA5__WEIM_WEIM_DA_A_5,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA6__WEIM_WEIM_DA_A_6,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA7__WEIM_WEIM_DA_A_7,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA8__WEIM_WEIM_DA_A_8,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA9__WEIM_WEIM_DA_A_9,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA10__WEIM_WEIM_DA_A_10,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA11__WEIM_WEIM_DA_A_11,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA12__WEIM_WEIM_DA_A_12,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA13__WEIM_WEIM_DA_A_13,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA14__WEIM_WEIM_DA_A_14,			//    - for CPLD logic
	MX6Q_PAD_EIM_DA15__WEIM_WEIM_DA_A_15,			//    - for CPLD logic

	MX6Q_PAD_NANDF_CS1__GPIO_6_14,	//    - for CPLD logic LPC_IRQ0
	MX6Q_PAD_NANDF_CS3__GPIO_6_16,	//    - for CPLD logic LPC_IRQ1
	MX6Q_PAD_NANDF_ALE__GPIO_6_8,	//    - for CPLD logic LPC_IRQ2
        
    /* GPIO2 */ 
	MX6Q_PAD_EIM_A22__GPIO_2_16,	//    - for CPLD logic
	MX6Q_PAD_EIM_A20__GPIO_2_18,	//    - for CPLD logic
	MX6Q_PAD_EIM_A19__GPIO_2_19,	//    - for CPLD logic
	MX6Q_PAD_EIM_A18__GPIO_2_20,	//    - for CPLD logic
	MX6Q_PAD_EIM_A17__GPIO_2_21,	//    - for CPLD logic
	MX6Q_PAD_EIM_A16__GPIO_2_22,	//    - for CPLD logic
	MX6Q_PAD_EIM_A23__GPIO_6_6,	//    - for CPLD logic
	MX6Q_PAD_EIM_WAIT__GPIO_5_0,	//    - for CPLD logic
	...
	MX6Q_PAD_EIM_D22__GPIO_3_22,		//  power enable
    ...
    /*I2C BUS*/
		/* I2C1 */
	MX6Q_PAD_EIM_D21__I2C1_SCL,			//	I2C1_SCL - SMB
	...
	MX6Q_PAD_GPIO_16__I2C3_SDA,			//	I2C3_SDA
...
static iomux_v3_cfg_t mx6qd_seco_q7_pads_revB[] = {
	/* ECSPI1 */
	MX6Q_PAD_EIM_D17__ECSPI1_MISO,      		//    SPI  MISO
	MX6Q_PAD_EIM_D18__ECSPI1_MOSI,      		//    SPI  MOSI
	MX6Q_PAD_EIM_D16__ECSPI1_SCLK,      		//    SPI  SCLK
	MX6Q_PAD_EIM_D19__ECSPI1_SS1,				//    SPI  CS1
	MX6Q_PAD_EIM_D24__GPIO_3_24,			    //    SPI  CS2
	MX6Q_PAD_EIM_D25__GPIO_3_25,			    //    SPI  CS3

	MX6Q_PAD_SD2_CMD__GPIO_1_11,				//	  AUDIO AC97 RESET
};


static iomux_v3_cfg_t mx6qd_seco_q7_pads_revD[] = {
	/* ECSPI1 */
	MX6Q_PAD_EIM_D17__ECSPI1_MISO,      		//    SPI  MISO
	MX6Q_PAD_EIM_D18__ECSPI1_MOSI,      		//    SPI  MOSI
	MX6Q_PAD_EIM_D16__ECSPI1_SCLK,      		//    SPI  SCLK
	MX6Q_PAD_EIM_A21__GPIO_2_17,                //    SPI  CS0
	MX6Q_PAD_EIM_D19__GPIO_3_19,				//    SPI  CS1
	/* ECSPI2 */
	MX6Q_PAD_DISP0_DAT17__ECSPI2_MISO,     		//    SPI  MISO
	MX6Q_PAD_DISP0_DAT16__ECSPI2_MOSI,     		//    SPI  MOSI
	MX6Q_PAD_DISP0_DAT19__ECSPI2_SCLK,     		//    SPI  SCLK
	MX6Q_PAD_DISP0_DAT18__GPIO_5_12,		    //    SPI  CS1
	MX6Q_PAD_DISP0_DAT15__GPIO_5_9,			//    SPI  CS2

	MX6Q_PAD_DISP0_DAT2__GPIO_4_23,				//	  AUDIO AC97 RESET
};
